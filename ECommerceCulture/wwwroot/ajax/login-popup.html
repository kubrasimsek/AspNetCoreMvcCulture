<div class="modal-wrapper">
    ...
    <div class="social-login-wrapper">
        ...
        <div class="btn-group">
            <a class="btn btn-social-login btn-md btn-gplus mb-1"><i class="fab fa-google-plus-g"></i><span>Google</span></a>
            <a class="btn btn-social-login btn-md btn-facebook mb-1"><i class="fab fa-facebook-f"></i><span>Facebook</span></a>
            <a class="btn btn-social-login btn-md btn-twitter mb-1"><i class="fab fa-twitter"></i><span>Twitter</span></a>
        </div>
    </div>
</div>